...
OPENKINECT_BIN="${OPENKINECT_BIN:-/usr/local/bin/openkinect-v2d}"
OPENKINECT_LIBDIRS="${OPENKINECT_LIBDIRS:-/usr/local/lib:/usr/local/lib64}"

export LD_LIBRARY_PATH="$OPENKINECT_LIBDIRS${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}"
